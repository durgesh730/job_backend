...
module.exports.JobController = require("./job.contoller")
module.exports.ApplicantController = require("./jobApplicant.controllor")

module.exports.InventoryAuthController = require("./inventory/auth.inventory.controllor")
module.exports.CustomerController = require("./inventory/customer.controllor")
